...
### Changed
- Flow variable substitution now only supports `{{ var }}` syntax; `${var}` is preserved for host languages such as JavaScript.

### Removed
- Removed backward-compatible `${var}` flow variable substitution.
